...
const translations = {
  ru: {
    ...
    brand: { name: 'Кафе · Фиксация заказов', ariaLabel: 'Ввод данных кафе' },
    ...
    form: {
      ...
      buttons: { calculate: 'Рассчитать успешность', reset: 'Очистить форму' },
    },
    badge: { quickEntry: 'Быстрый ввод', summary: 'Сводка', activity: 'Активность' },
    hero: {
      h1: 'Регистрируйте заказы, клиентов и заметки смены в одном окне.',
    ...
    summary: { title: 'Текущее состояние', totalRecords: 'Всего записей', lastCuisine: 'Последняя кухня', lastLocation: 'Последняя локация' },
    log: {
  ...
  es: {
    meta: { title: 'Café · Entrada de datos' },
    skip: 'Saltar al contenido',
    brand: { name: 'Café · Captura de pedidos', ariaLabel: 'Entrada de datos del café' },
    theme: { toggleAria: 'Cambiar tema' },
    form: {
      langSelect: 'Seleccionar idioma',
      title: 'Nuevo registro',
      description: 'Completa el formulario y guarda la entrada para verla reflejada en el panel lateral.',
      labels: {
        customer: 'Cliente',
        phone: 'Teléfono',
      ...
      buttons: { calculate: 'Calcular éxito', reset: 'Limpiar formulario' },
    },
    badge: { quickEntry: 'Entrada rápida', summary: 'Resumen', activity: 'Actividad' },
    hero: {
      h1: 'Registra pedidos, clientes y notas del turno en una sola vista.',
    ...
    summary: { title: 'Estado actual', totalRecords: 'Total de registros', lastCuisine: 'Última cocina', lastLocation: 'Última ubicación' },
    log: {
